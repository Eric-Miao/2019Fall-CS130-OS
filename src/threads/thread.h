...
void thread_check_block (struct thread *, void *aux);
void recent_cpu_increse_one (void);
void thread_foreach_update_recent_cpu (struct thread *, void *);
void update_load_avg (void);
void update_recent_cpu (void);
void thread_update_priority_advanced (struct thread *);

...
/*open the dir of the current thread*/
struct dir *
dir_open_current()
{
...
bool dir_remove(struct dir *dir, const char *name)
{
  ...
  if (inode_is_dir(inode))
  {
    ...
    for (offs = 0; inode_read_at(inode, &temp, sizeof temp, offs) == sizeof temp;
         offs += sizeof temp)
    {
        if (temp.in_use && strcmp(temp.name, ".") != 0 && strcmp(temp.name, "..") != 0)
        {
